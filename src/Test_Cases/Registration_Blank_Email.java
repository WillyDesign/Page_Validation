...
public class Registration_Blank_Email {
	...
	public static void main(String[] args) throws InterruptedException {  
     ...
     // Find the element with the html info tooltip
        ...
        if (message.equals("Please enter a valid email address.")) {
            System.out.println("The error message is displayed correctly. Validation for blank Email field is Passed");
        } else {
            System.out.println("The error message is not displayed correctly. Validation for blank Email field is Failed");
        }
