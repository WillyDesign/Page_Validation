...
public class Registration_Blank_Pincode {
...
Registration_Page.Registration_Link(driver).click();
     ...
     // Find the element with the html info tooltip
        driver.findElement(By.name("pincode"));  
        String message = driver.findElement(By.name("pincode")).getAttribute("validationMessage");
        System.out.println("The error message displayed on the page is: " +message);
        
        // Validate the text message
        if (message.equals("Please enter a pincode.")) {
            System.out.println("The error message is displayed correctly. Validation for blank Pincode field is Passed");
        } else {
            System.out.println("The error message is not displayed correctly. Validation for blank Pincode field is Failed");
        }
