...
public class Registration_Blank_Gender {
	...
	public static void main(String[] args) throws InterruptedException {  
     ...
     // Find the element with the html info tooltip
       // driver.findElement(By.id("dob"));  
        ...
        if (errorMessageText.equals("Please select a gender")) {
            System.out.println("The error message is displayed correctly. Validation for blank Gender value is Passed");
        } else {
            System.out.println("The error message is not displayed correctly. Validation for blank Gender value is Failed");
        }
